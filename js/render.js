...
const CATEGORY_ICONS = {
  ...
  'Single Sound Crackers': 'zap',
  'Bombs':               'bomb',
  'Bijili':              'zap',
  'Color Matches':       'flame',
  'Chakkaram - Spinners':'loader',
  'Mini Fountains':      'droplets',
  'Mega Fountains':      'droplets',
  'Special Fountains':   'droplets',
  'Fountain with Bomb':  'boom-box',
  'Fancy Novelties':     'wand-2',
  'Ariel Shots Continuous Functions': 'rocket',
  'Rider Shots':         'rocket',
  'Musical Shots':       'music',
  'Special Function Shots': 'rocket',
  '2026 Special':        'sparkles',
  'Festival Crackers':   'party-popper',
};
...
const CATEGORY_COLORS = {
  ...
  'Single Sound Crackers':'#6A1B9A',
  'Bombs':               '#B71C1C',
  'Bijili':              '#7B1FA2',
  'Color Matches':       '#F57F17',
  'Chakkaram - Spinners':'#00897B',
  'Mini Fountains':      '#0288D1',
  'Mega Fountains':      '#01579B',
  'Special Fountains':   '#0097A7',
  'Fountain with Bomb':  '#E65100',
  'Fancy Novelties':     '#EF6C00',
  'Ariel Shots Continuous Functions': '#303F9F',
  'Rider Shots':         '#3949AB',
  'Musical Shots':       '#4527A0',
  'Special Function Shots': '#1A237E',
  '2026 Special':        '#F9A825',
  'Festival Crackers':   '#C62828',
};
